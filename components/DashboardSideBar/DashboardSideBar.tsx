...
const DashboardSideBar = () => {
  ...
  return (
    <div
      className={`fixed left-0 top-0 max-w-[250px] w-full duration-[400ms] h-full z-30 bg-white shadow-md
        ${
          showNav
    ...
    >
          ...
          <Link href='/home'>
            ...
            >
              ...
              <span className='inline-block ml-4'>
                <Text variant='paragraph_3' className={`font-bold capitalize`}>
                  Home
                </Text>
              </span>
            </a>
      ...
      >
        ...
        <Text variant='paragraph_3' className='font-bold'>
          Log Out
        </Text>
      </Button>
    </div>
