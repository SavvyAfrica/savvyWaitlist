                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="relative p-6 flex-auto">
                            <Text variant='paragraph_4' className='font-medium text-center text-[#2F294D] mb-7'>
                                Let’s help with troubleshooting, Installation, repair, and other issues.<br/><br/>
                                <Link href="/terms">
                                    <a className="text-red-600 underline">Terms and Conditions apply</a>
                                </Link>
                            </Text>
                            ...
                            <Button className='w-full rounded-xl font-semibold text-center py-2.5 px-4 bg-[#00B0F0]'>
                                <Text variant='paragraph_4' className="font-bold text-white">Send Message</Text>
                            </Button>
                        </div>
                    </div>
                </div>
