...
interface IMyProp {
  swapOption1IsOpen: boolean;
  setSwapOption1IsOpen: Dispatch<SetStateAction<boolean>>;
}

function SwapOption1({setSwapOption1IsOpen, swapOption1IsOpen}: IMyProp) {
  ...
  return (
    <>
      <div
        ...
        onClick={() => setSwapOption1IsOpen(!swapOption1IsOpen)}
      >
        <div
          ...
          <div className="w-full py-8 pb-6 md:px-8 px-6 flex flex-col justify-start items-center">
            <div className="flex sm:flex-row flex-col justify-center items-center mb-8 md:w-11/12 w-full">
              <span className="text-center sm:text-left block mr-0 sm:mr-auto mb-4 sm:mb-0">
                <Text variant='paragraph_3' className='font-semibold text-[#2F294D]'>Mac book core i5</Text>
                <span className="font-bold text-[#2F294D] text-base">₦450,000</span>
              </span>

              <span className="text-center sm:text-left block ml-0 sm:ml-auto">
                <Text variant='paragraph_4' className='font-semibold text-xs text-[#2F294D]'>May 16, 2022 <br />
