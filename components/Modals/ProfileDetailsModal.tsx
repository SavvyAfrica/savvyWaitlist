...
function ProfileDetailsModal({ currentSubject, createObjectURL, handleUploadProfileImageToClient, handleUploadProfileImageToServer }: any) {
          ...
          >
            ...
            >
              ...
              <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                ...
                {/*body*/}
                <form className='p-6' onChange={handleUploadProfileImageToClient} onSubmit={handleUploadProfileImageToServer} >
                  <div className="w-full flex flex-col justify-center items-center mb-[40px]">
                    <div 
                      className="block h-[80px] md:h-[130px] w-[80px] md:w-[130px] mb-[15px] relative"
                    >
                    ...
                    <div className="">
                      <Text variant='paragraph_1' className="font-bold text-gray-700">
