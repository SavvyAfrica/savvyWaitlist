...
function SetupAccountModal({setShowSetupAccModal, setShowVerifyEmp_StudModal, setShowVerifyEmployeeCompModal}: MyProps) {
    ...
    const handleContinueClick = () => {
        ...
        }else if(setupAcctSelected.startsWith('STARTUP OR CORPORATE ORGANIZATION')){
            setShowSetupAccModal(false);
                        ...
                        <div className="flex flex-col w-full mb-8">
                            {setupAcctData.map((element, index): React.ReactNode => {
                                ...
                                >
                                    ...
                                    {setupAcctSelected === element ? renderIcon(element) : null}
                                </span>
                                )
                            })}
                        </div>
