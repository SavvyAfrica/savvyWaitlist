...
function VerifyEmp_StudModal({setShowVerifyEmp_StudModal}: MyProps) {
  ...
  let [categories] = useState({
    Employee: [
      {
        id: 1,
        children: <>Bank Verification Number (BVN)<span className='text-red-600'>*</span></>,
        htmlFor: 'bvn',
        inputId: 'bvn',
        name: 'bvn',
        type: 'tel'
      ...
      {
        id: 2,
        children: <>What's your monthly income?<span className='text-red-600'>*</span></>,
        htmlFor: 'income',
        inputId: 'income',
        name: 'income',
        type: 'tel'
      ...
      {
        id: 3,
        children: <>What state do you live in or work?<span className='text-red-600'>*</span></>,
      ...
      {
        id: 5,
        children: <>Upload a valid ID<span className='text-red-600'>*</span></>,
        htmlFor: 'idUpload',
        inputId: 'idUpload',
        name: 'idUpload',
        type: 'file',
    ...
    Student: [
      ...
      {
        id: 2,
        children: <>What's the name of your school?<span className='text-red-600'>*</span></>,
        htmlFor: 'schoolName',
        inputId: 'schoolName',
        name: 'schoolName',
        type: 'text'
      ...
      {
        id: 5,
        children: <>Upload your student ID<span className='text-red-600'>*</span></>,
        htmlFor: 'idUpload',
        inputId: 'idUpload',
        name: 'idUpload',
        type: 'file'
  ...
  const {handleChange, employeeState, studentState, formErrors} = useForm(empl_StudForm);
