...
function Frame() {
  return (
    <div className="maxWidth mx-auto w-full flex flex-col justify-center items-center px-5 py-3 md:mb-36 mb-20">
      <div className={`frame rounded-[10px] xl:w-[52%] lg:w-[70%] 
        md:w-[80%] w-full sm:h-[98px] h-auto flex justify-center items-center`
      }>
        <Text
          variant="home_heading_3_32px"
          className="sm:text-[32px] text-[24px] text-center sm:px-0 px-10 sm:py-0 py-3 font-extrabold text-[#292D32] mx-auto"
        >
      ...
      <div className="flex justify-around items-center">
        ...
        <div className={`sm:w-[80px] w-[60px] sm:h-[80px] h-[60px] rounded-full bg-[#F4F7FE] flex justify-center 
