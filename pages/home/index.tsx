            ...
            >
                ...
                >
                    ...
                    <div className="max-w-[280px] sm:my-0 my-6">
                        <p className="text-base font-medium text-center sm:px-5 px-0">Do you know how to complete account set up?</p>
                    </div>

                    <Button 
                        className='w-[150px] border border-[#00B0f0] border-solid rounded-3xl py-2 px-4 sm:mr-auto mr-0 text-sm'>
