    ...
    <div>
      <DashboardLayout>
        ...
        >
          ...
          <div className='w-1/2'>
            <Text className='font-semibold text-2xl text-[#2F294D]'>
            ...
            <Text className='font-normal text-[13px] text-[#2F294D] opacity-50 mb-[30px] max-w-full'>
              Would you like to return your tech for swap or sale in the future?
              If yes, pick a usage period below. Savvy will notify you when it’s
              time and take care of the rest.
            </Text>
            ...
            <div className='flex flex-row justify-between items-center mb-[52px]'>
              <Text className='font-semibold xl:text-[40.54px] text-[35px] leading-[60px]'>
                ₦13,000
              </Text>
