...
function account() {
  ...
  let accountNumber: string =
    walletState === undefined
      ? '1230043787'
      : walletState.wallet[0].accountNumber
  let accountName: string =
    walletState === undefined
      ? 'TEST-MANAGED-ACCOUNT'
      : walletState.wallet[0].accountName
  let bankName: string =
    walletState === undefined ? 'Test Bank' : walletState.wallet[0].bankName
  ...
  return (
    <>
      <Dashboard>
        ...
        <section className='w-full flex xl:flex-row flex-col h-auto xl:h-[156.79px] items-center justify-center gap-3.5 flex-initial mb-3.5'>
          ...
          <DashboardContentBox className='xl:w-2/6 sm:flex-row flex-col justify-center items-center'>
            <div className='sm:mr-auto mr-0 sm:mb-0 mb-6'>
              <Text
                variant='paragraph_1'
                className='text-[#1B2559] font-bold mb-5 sm:text-left text-center'
              >
                Complete Set Up
              </Text>
              <Text
                variant='paragraph_4'
                className='text-[#A1A0BD] font-medium sm:max-w-[190px] max-w-full sm:text-left text-center'
              >
        ...
        <section className='w-full h-auto xl:h-[340px] flex flex-col xl:flex-row items-start justify-start gap-3.5 flex-initial'>
          <DashboardContentBox className='xl:w-4/6 flex-col'>
            <div className='mb-8 sm:text-left text-center'>
              <Text variant='paragraph_1' className='text-[#292D32] font-bold'>
                Transactions
              </Text>
              <Text
                variant='paragraph_4'
                className='font-medium text-[#A1A0BD] sm:max-w-[388px] max-w-full sm:text-left text-center'
              >
