        ...
        >
          ...
          <div className="w-1/2">
            ...
            <Text className='font-normal text-[13px] text-[#2F294D] opacity-50 mb-[30px] max-w-full'>
              Select your plan and pay for the first rental period. When your rent ends, you can choose 
              to return, upgrade to the latest model or continue renting for 24 months to own it. 
            </Text>
            ...
            <div className="flex flex-row justify-between items-center mb-[52px]">
              <div className="">
                ...
                <Text className='font-medium text-[14.74px] leading-[22.11px] text[#2F294D]'>2 Weeks rent</Text>
              </div>
