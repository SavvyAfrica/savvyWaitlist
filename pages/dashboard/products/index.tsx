      ...
      <DashboardLayout>
        <div className="w-full pb-16 flex justify-between items-start">
          <div>
            ...
            <div className="w-auto lg:mt-0 mt-7 flex flex-row items-center">
              ...
              <Text className='font-bold ml-2.5 text-[#292d32] lg:text-[30px] sm:text-2xl text-lg lg:leading-10'>Buying Product Page</Text>
            </div>
          </div>
        ...
        <div className="w-full h-auto">
          ...
          <div className="mb-2.5 flex justify-between items-center">
            <Text className='font-bold text-base tracking-tight text-[#292D32]'>Top Interest</Text>
          ...
          <div className="mb-2.5 flex justify-between items-center">
            <Text className='font-bold text-base tracking-tight text-[#292D32]'>Popular Brands</Text>
          ...
          <div className="mb-[19.36px] bg-white inline-block inline-flex items-center flex-wrap rounded-[21.53px]">
            {popularBrands.map(popularBrand => (
              <Product 
                key={popularBrand.id}
                src={popularBrand.src}  
              />
            ))}
          </div>

          <div className="mb-2.5 flex justify-between items-center">
            <Text className='font-bold text-base tracking-tight text-[#292D32]'>Latest Model</Text>
